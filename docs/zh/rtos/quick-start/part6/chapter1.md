...
![image1](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image1.jpg)
...
![image2](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image2.jpg)
...
![image3](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image3.jpg)
...
![image4](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image4.jpg)

#### DEBUG电路设计

R128支持 USB（OTG）、UART、JTAG与 SWD 等多种调试方式，客户可根据需要选择合适的调试方式，建议在设计时对相应的调试接口预留测试点方便后续调试验证。

![image5](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image5.jpg)
...
![image6](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image6.jpg)
...
![image7](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image7.jpg)
...
![image8](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image8.jpg)
...
![image9](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image9.jpg)
...
![image10](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image10.jpg)
...
![image11](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image11.jpg)
...
![image12](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image12.jpg)
...
![image13](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image13.jpg)

- MIC1-3建议组合成 2MIC+1AEC 电路；

MIC和 AEC参考设计如图所示。AEC 回路电阻电容参数与功放输出幅度和算法公司要求有关，参数以实际开发环境为准。

![image14](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image14.jpg)

![image15](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image15.jpg)

![image16](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image16.jpg)
...
![image17](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image17.jpg)
...
![image18](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image18.jpg)
...
![image19](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image19.jpg)
...
![image20](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image20.jpg)

#### 4层板设计参考

![image21](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image21.jpg)
...
![image22](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image22.jpg)

#### 四层板 Fanout 建议

![image23](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image23.jpg)
...
![image25](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image25.jpg)

![image26](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image26.jpg)
...
![image28](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image28.jpg)
...
![image29](http://photos.100ask.net/aw-r128-docs/rtos/quick-start/part6/chapter1/image29.jpg)

import{_ as i,r as p,o as l,c,a as s,b as n,d as t,e as a}from"./app-e85d5a28.js";const o={},d=a(`<h1 id="spi-驱动-tft-lcd-屏" tabindex="-1"><a class="header-anchor" href="#spi-驱动-tft-lcd-屏" aria-hidden="true">#</a> SPI 驱动 TFT LCD 屏</h1><p>R128 平台提供了 SPI DBI 的 SPI TFT 接口，具有如下特点：</p><ul><li>Supports DBI Type C 3 Line/4 Line Interface Mode</li><li>Supports 2 Data Lane Interface Mode</li><li>Supports data source from CPU or DMA</li><li>Supports RGB111/444/565/666/888 video format</li><li>Maximum resolution of RGB666 240 x 320@30Hz with single data lane</li><li>Maximum resolution of RGB888 240 x 320@60Hz or 320 x 480@30Hz with dual data lane</li><li>Supports tearing effect</li><li>Supports software flexible control video frame rate</li></ul><p>同时，提供了SPILCD驱动框架以供 SPI 屏幕使用。</p><p>本次使用的是 Dshan_Display Module，如下图：</p><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image1.png" alt=""></p><p>引脚配置如下：</p><table><thead><tr><th style="text-align:left;">R128 Devkit</th><th style="text-align:left;">TFT 模块</th></tr></thead><tbody><tr><td style="text-align:left;">PA12</td><td style="text-align:left;">CS</td></tr><tr><td style="text-align:left;">PA13</td><td style="text-align:left;">SCK</td></tr><tr><td style="text-align:left;">PA18</td><td style="text-align:left;">MOSI</td></tr><tr><td style="text-align:left;">PA9</td><td style="text-align:left;">PWM</td></tr><tr><td style="text-align:left;">PA20</td><td style="text-align:left;">RESET</td></tr><tr><td style="text-align:left;">PA19</td><td style="text-align:left;">RS</td></tr><tr><td style="text-align:left;">3V3</td><td style="text-align:left;">3.3V</td></tr><tr><td style="text-align:left;">GND</td><td style="text-align:left;">GND</td></tr></tbody></table><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image2.png" alt=""></p><h2 id="载入方案" tabindex="-1"><a class="header-anchor" href="#载入方案" aria-hidden="true">#</a> 载入方案</h2><p>我们使用的开发板是 R128-Devkit，需要开发 C906 核心的应用程序，所以载入方案选择 <code>r128s2_module_c906</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token builtin class-name">source</span> envsetup.sh 
$ lunch_rtos <span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image3.png" alt=""></p><h2 id="设置-spi-驱动" tabindex="-1"><a class="header-anchor" href="#设置-spi-驱动" aria-hidden="true">#</a> 设置 SPI 驱动</h2><p>屏幕使用的是SPI驱动，所以需要勾选SPI驱动，运行 <code>mrtos_menuconfig</code> 进入配置页面。前往下列地址找到 <code>SPI Devices</code></p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>Drivers Options  <span class="token operator">--</span><span class="token operator">-&gt;</span>
    soc related device drivers  <span class="token operator">--</span><span class="token operator">-&gt;</span>
        SPI Devices <span class="token operator">--</span><span class="token operator">-&gt;</span>
        <span class="token operator">-</span><span class="token operator">*</span><span class="token operator">-</span> enable spi driver
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image4.png" alt=""></p><h3 id="配置-spi-引脚" tabindex="-1"><a class="header-anchor" href="#配置-spi-引脚" aria-hidden="true">#</a> 配置 SPI 引脚</h3><p>打开你喜欢的编辑器，修改文件：<code>board/r128s2/module/configs/sys_config.fex</code>，在这里我们不需要用到 SPI HOLD与SPI WP引脚，注释掉即可。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>;----------------------------------------------------------------------------------
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image5.png" alt=""></p><h2 id="设置-pwm-驱动" tabindex="-1"><a class="header-anchor" href="#设置-pwm-驱动" aria-hidden="true">#</a> 设置 PWM 驱动</h2><p>屏幕背光使用的是PWM驱动，所以需要勾选PWM驱动，运行 <code>mrtos_menuconfig</code> 进入配置页面。前往下列地址找到 <code>PWM Devices</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Drivers Options  ---&gt;
    soc related device drivers  ---&gt;
        PWM Devices ---&gt;
        -*- enable pwm driver
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image6.png" alt=""></p><h3 id="配置-pwm-引脚" tabindex="-1"><a class="header-anchor" href="#配置-pwm-引脚" aria-hidden="true">#</a> 配置 PWM 引脚</h3><p>打开你喜欢的编辑器，修改文件：<code>board/r128s2/module/configs/sys_config.fex</code>，增加 PWM1 节点</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[pwm1]
pwm_used        = 1
pwm_positive    = port:PA9&lt;4&gt;&lt;0&gt;&lt;3&gt;&lt;default&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image7.png" alt=""></p><h2 id="设置-spi-lcd-驱动" tabindex="-1"><a class="header-anchor" href="#设置-spi-lcd-驱动" aria-hidden="true">#</a> 设置 SPI LCD 驱动</h2><p>SPI LCD 由专门的驱动管理。运行 <code>mrtos_menuconfig</code> 进入配置页面。前往下列地址找到 <code>SPILCD Devices</code> ，注意同时勾选 <code>spilcd hal APIs test</code> 方便测试使用。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Drivers Options  ---&gt;
    soc related device drivers  ---&gt;
        [*] DISP Driver Support(spi_lcd)
        [*]   spilcd hal APIs test
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image8.png" alt=""></p><h3 id="选择驱动的显示屏" tabindex="-1"><a class="header-anchor" href="#选择驱动的显示屏" aria-hidden="true">#</a> 选择驱动的显示屏</h3>`,34),r=s("code",null,"LCD_FB panels select",-1),u={href:"https://r128.docs.aw-ol.com/sdk_base/spilcd/",target:"_blank",rel:"noopener noreferrer"},v=a(`<p>进入 <code>LCD_FB panels select</code> 选项</p><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image9.png" alt=""></p><p>选择并勾选 <code>[*] LCD support JLT35031C panel</code></p><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image10.png" alt=""></p><h3 id="配置-spi-lcd-引脚" tabindex="-1"><a class="header-anchor" href="#配置-spi-lcd-引脚" aria-hidden="true">#</a> 配置 SPI LCD 引脚</h3><p>打开你喜欢的编辑器，修改文件：<code>board/r128s2/module/configs/sys_config.fex</code></p><blockquote><p>FEX 解析器不支持行尾注释，直接复制需要删除行尾的注释</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>;----------------------------------------------------------------------------------
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image11.png" alt=""></p><h2 id="结果" tabindex="-1"><a class="header-anchor" href="#结果" aria-hidden="true">#</a> 结果</h2><p>以上配置完成后，编译打包烧录，上电后屏幕背光亮起，屏幕为黑色。</p><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image12.png" alt=""></p><p>并且可以在 LOG 中看到 <code>[LCD_FB] lcd_fb_probe,line:103:</code> 和 <code>spi_clk_init()1609 [spi1] clk rate auto adjust to 48000000</code> SPI 初始化的 LOG。</p><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image13.png" alt=""></p><p>然后可以用 <code>test_spilcd</code> 测试屏幕，日志如下</p><p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image14.png" alt=""></p><p>执行命令之后屏幕会变为黄色。</p>`,17),m={href:"https://r128.docs.aw-ol.com/sdk_base/spilcd/#_20",target:"_blank",rel:"noopener noreferrer"},k=a(`<p><img src="http://photos.100ask.net/aw-r128-docs/rtos/demo/part1/chapter16/image15.png" alt=""></p><p><code>test_spilcd</code> 代码如下：</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;stdio.h&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function b(h,g){const e=p("ExternalLinkIcon");return l(),c("div",null,[d,s("p",null,[n("在 SPILCD 驱动选择界面可以看到 "),r,n(" 选择 SPI 屏幕的驱动，"),s("strong",null,[n("本文只注重于 SPI LCD 的使用，驱动编写请查看《"),s("a",u,[n("SPI LCD 显示驱动"),t(e)]),n("》")])]),v,s("ul",null,[s("li",null,[n("SPI 屏幕颜色说明：<"),s("a",m,[n("SPI LCD 显示驱动 - SPI LCD 颜色相关问题"),t(e)]),n(">")])]),k])}const f=i(o,[["render",b],["__file","chapter16.html.vue"]]);export{f as default};
